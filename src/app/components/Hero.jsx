...
// import milestoneScreen from '@/images/milestoneScreen.png'
// import verifyScreen from '@/images/verifyScreen.png'
...
//   return (
//     <div ref={containerRef} className="flex flex-col items-center hero  mx-auto overflow-hidden rounded-b-4xl w-full">
...
//           <h1 className="lg:text-8xl md:text-7xl text-[3rem] tracking-tight text-[#fff] font-semibold text-center title md:pb-3 md:-pb-0 -pb-3 ">Neucleus Core</h1>
...
const Hero = () => {
  ...
  useGSAP(() => {
    const splitTextInstances = []
    // Only animate titles that have .title class
    const textSplit = new SplitText('.title', { type: 'chars, words' })
    ...
    return () => {
      splitTextInstances.forEach((t) => t.revert())
      mainTimeline.kill()
    }
  }, { scope: containerRef })
  ...
  return (
    <div
      ref={containerRef}
      className="flex flex-col items-center hero mx-auto overflow-hidden rounded-b-4xl w-full"
    >
      {/* Hero Text Section */}
      <div className="flex flex-col lg:w-[58%] md:w-[70%] w-full flex-grow flex-shrink-0 justify-center h-[40rem] md:mt-17 md:-mb-40 -mb-100 relative z-20">
        {/* Static Headings */}
        <h1 className="lg:text-8xl md:text-7xl text-[3rem] tracking-tight text-[#fff] font-semibold text-center md:pb-3">
          Neucleus Core
        </h1>
        <h1 className="lg:text-8xl md:text-7xl text-[3rem] tracking-tight text-[#273243] font-semibold text-center md:pb-3">
          <span className="text-[#ea922c]">Chain</span>
        </h1>

        {/* Static Paragraph */}
        <p className="text-center text-[#fff] md:px-10 md:py-5 py-3 px-6">
          First Native Blockchain for the Next Generation of Decentralized Apps.
          Start mining Nucleus Core cryptocurrency today with lightweight
          architecture built for mobile hardware.
        </p>

        {/* Download Buttons */}
        <div className="flex space-x-4 justify-center items-center">
          <Link
            href="https://play.google.com/store/apps/details?id=com.minenu.nu_app"
            className="lg:w-[25%] md:w-[22%] w-[30%]"
          >
            <Image
              src={android}
              width={1000}
      ...
      <div className="w-full mx-auto relative h-full mb-10">
        ...
        {/* Center Card */}
        <div className="absolute z-2 rounded-[3rem] w-[22rem] left-1/2 -translate-x-1/2 md:translate-y-0 translate-y-40 stake md:bg-[#171717] bg-black p-5 flex flex-col top-30 animate-screen">
          <div className="flex flex-col space-y-3 absolute -left-1 top-20">
            <div className="w-1 h-15 md:bg-[#171717] bg-black"></div>
            <div className="w-1 h-15 md:bg-[#171717] bg-black"></div>
          </div>
          ...
          <div className="flex justify-between items-center p-3">
            ...
            <div className="flex space-x-5">
              ...
              <div className="flex justify-center items-center border border-[#e4e4e462] md:bg-gradient-to-t md:from-[#171717] md:to-[#e4e4e431] bg-black rounded-full w-3 h-3">
                <div className="rounded-full w-1 h-1 border border-[#e4e4e41e]"></div>
              </div>
            </div>
          </div>
        ...
        {/* Left Floating Card */}
        <div className="absolute z-0 rounded-[3rem] md:w-[18rem] w-[15rem] left-60 md:bg-[#171717] bg-black substake p-5 flex-col md:flex hidden top-80 rotate-25 animate-verify">
          <div className="flex flex-col space-y-3 absolute -left-1 top-20">
            <div className="w-1 h-15 md:bg-[#171717] bg-black"></div>
            <div className="w-1 h-15 md:bg-[#171717] bg-black"></div>
          </div>
        ...
        {/* Right Floating Card */}
        <div className="absolute z-0 rounded-[3rem] md:w-[18rem] w-[15rem] substake right-60 md:bg-[#171717] bg-black p-5 md:flex hidden flex-col top-80 -rotate-25 animate-verify">
          <div className="flex flex-col space-y-3 absolute -left-1 top-20">
            <div className="w-1 h-15 md:bg-[#171717] bg-black"></div>
            <div className="w-1 h-15 md:bg-[#171717] bg-black"></div>
          </div>
