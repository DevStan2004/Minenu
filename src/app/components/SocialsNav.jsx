...
const SocialsNav = ({icons}) => {
    ...
    return (
        <div data-prevent-lenis className='fixed md:left-1/2 flex justify-center md:-translate-x-1/2 right-5 md:bottom-10 bottom-5 md:bg-[#171717] md:p-3 rounded-xl z-10 transition-all duration-300 linear' 
                ...
                {icons.map((icon, index) => (
                    <div key={index} className="relative">
                        ...
                        <div 
                            ...
                            className={`flex justify-center items-center md:w-12 md:h-12 md:p-0 p-1 sm:social rounded-full bg-[#262626] transition-mx transition-translate-y cursor-pointer relative transition-scale duration-300 linear 
