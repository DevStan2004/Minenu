    ...
    <div className='flex justify-center w-full my-30'>
        <div className="w-[55rem] flex flex-col space-y-5">
            ...
            <div className="bg-white shadow rounded-lg w-full p-4 flex flex-col space-y-4">
                ...
                <p className="text-[#4a5565]">By accessing or using Minenu's services, including Minenu Wallet and Minenu Pay, you agree to comply with and be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services.</p>
            </div>
            <div className="bg-white shadow rounded-lg w-full p-4 flex flex-col space-y-4">
                <div className="my-3 border-b py-2">
                ...
                <ul className='list-disc mx-10'>
                    ...
                    <li className="text-[#4a5565]">Use Minenu services lawfully and not or fraudulent or unauthorized activities.</li>
            ...
            <div className="bg-white shadow rounded-lg w-full p-4 flex flex-col space-y-4">
                ...
                <p className="text-[#4a5565]">All content, trademarks, logos, and intellectual property related to Minenu's services are owned by Minenu or its licensors. Users may not copy, modify, distribute, or use Minenu's intellectual property without prior written consent.</p>
            </div>
            <div className="bg-white shadow rounded-lg w-full p-4 flex flex-col space-y-4">
                <div className="my-3 border-b py-2">
                    <h3 className='text-2xl text-[#101828] font-semibold'>IV LImittion of Liability</h3>
                </div>
                <p className="text-[#4a5565]">Minenu is not liable for:</p>
                <ul className='list-disc mx-10'>
